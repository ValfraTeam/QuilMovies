    ...
    <body>
        ...
        <section class="col-lg-7 usuario" style="height:400px;overflow-y:scroll;">
            <?php foreach($allusers as $user) {?>
                ...
                <div class="right">
                    <a href="<?php echo $helper->url("usuario","borrar"); ?>&id_usuario=<?php echo $user->id_usuario; ?>" class="btn btn-danger">Borrar</a>
                </div>
                <hr/>
            <?php } ?>
        </section>
        <footer class="col-lg-12">
            <hr/>
           QUILMOVIES - Las Mejores Peliculas -  By   <a href="http://i-fra.com">www.i-fra.com </a> - Copyright &copy; <?php echo  date("Y"); ?>
        </footer>
    </body>
</html>